        ...
        (
           array
            ...
            (
              ...
              'context' => "",
              'content' => "Certains voudront se rebeller en mettant des variables globales. Bah qu'ils se rebellent, je leur mettrai zéro. Ils se rebellent, zéro. Ils se rebellent, zéro. Ils se rebellent, zéro...\nCurieusement ils se lassent toujours avant moi...",
            ),
            array
            (
              'id' => "5",
            ...
            (
              ...
              'content' => "*regarde sa vaisselle sale avec des bébêtes qui courent dedans*\n\nJ'ai créé LA VIE!",
            ),
            array
            (
              'id' => "16",
            ...
            (
              ...
              'content' => "Junior : T'as vu, moi ils me disent bonjour !\n\nKrisboul : C'est pas grave, je les emmerde.",
            ),
            array
            (
              'id' => "23",
            ...
            (
              ...
              'content' => "Seine ! (pas de réponse)\n\nSoula ! ... Seine ? Sous la Seine...",
            ),
            array
            (
              'id' => "26",
              ...
              'content' => "Pheteon > Noël, c'est pas censé être la période 42sh?\n\nMech > Non, en fait Noël est une célébration religieuse en rapport avec la naissance de Jésus de Nazareth.",
            ),
            array
            (
              'id' => "27",
            ...
            (
              ...
              'content' => "Comment j'me suis niqué mon coup avec une meuf :\n\n - J'en ai marre de mon mec.\n\n - Ah ouais pourquoi ?\n\n - Il fait que de jouer à WoW.\n\n - Ah merde c'est con.\n\n - J'veux changer de mec...\n\n - Il est à quel level ?",
            ),
            array
            (
              'id' => "29",
            ...
            (
              ...
              'content' => "philip_o : En gros, tu codes toute la nuit jusqu'à l'exo 3 et puis t'as zéro quand même.\n\nRedox : Au moins, tu auras appris quelque chose...",
            ),
            array
            (
              'id' => "32",
            ...
            (
              ...
              'content' => "Et voila, un Makefile qui part en boucle infinie...\n\n/*...après quelques instants... */\n\nAh non, c'est les erreurs !",
            ),
            array
            (
              'id' => "34",
            ...
            (
              ...
              'rank' => "112",
              'author' => "Warren Seine",
              'context' => "Justificatif d'absence à un cours\n(notez que ceci lui a valu un conseil de discipline et un \"Mais tu es un fou !\" de M. Christian Dujardin)",
            ...
            (
              ...
              'content' => "Ma machine boot...et ne me rend jamais la main.... ça vous rappelle un OS?...\nUne main levée? Un pro-Microsoft?",
            ),
            array
            (
              'id' => "46",
            ...
            (
              ...
              'content' => "Akim : Les gens qui sont dans le Q je les appellerai...\n\ndenuzi_l : Les morpions.",
            ),
            array
            (
              'id' => "48",
              ...
              'content' => "Akim : Est-ce que quelqu'un a déjà essayé de payer un prof pour avoir une meilleure note au partiel ?\n\n(... silence ...)\n\nAkim : Bon est-ce que quelqu'un a 50cts pour la machine à café ?",
            ),
            array
            (
              'id' => "49",
            ...
            (
              ...
              'content' => "Akim : Par quels états peut-on arriver en 4 de manière spontanée?\n\nElèves : 0... 1\n\nAkim : 0 et 1\n\nElèves : 2\n\nAkim : Et 2\n\nElèves : 3\n\nAkim : Et 3 ... Et 1, et 2, et 3 zéros...\n",
            ),
            array
            (
              'id' => "51",
            ...
            (
              ...
              'content' => "Ca c'est vous...\n\nEn terme de neurones, c'est déjà bien, ça vous en fait cinq.\n\nCa fait un car de flics !",
            ),
            array
            (
              'id' => "53",
            ...
            (
              ...
              'content' => "Si si, je te jure, 175km/h, j'aurais voulu prendre un screenshot !\n\n*blanc*\n\nOuais enfin une photo, faites pas genre vous m'avez pas compris...",
            ),
            array
            (
              'id' => "58",
              ...
              'content' => "Le prof :Tu dois être Maître de la Conversion.\n\nRomain Lofaso : Que la force du bit soit avec toi !",
            ),
            array
            (
              'id' => "59",
              ...
              'content' => "Prenons lambda un réel quelconque. Quel pauvre réel... Bah oui, vous vous imaginez ? Mettez-vous deux secondes à la place de ce réel. \n(Il trace une droite au tableau et en pointant les extrémités :) Vous imaginez ? Il passe sa vie entre là et là ! C'est pas bien palpitant !",
            ),
            array
            (
              'id' => "60",
            ...
            (
              ...
              'content' => "Laurent : Ça sert à rien les mômes, ça braille, ça pleure...\n\nGabriel : ...et ça compile pas !",
            ),
            array
            (
              'id' => "64",
            ...
            (
              ...
              'author' => "Jean-Marc Le Roux",
              'context' => "",
              'content' => "Libérer la mémoire c'est pour les pauvres, il suffit d'acheter des barrettes de RAM.\n",
            ),
            array
            (
              'id' => "66",
            ...
            (
              ...
              'content' => "Marwan: Et donc on peut parcourir la liste des fists. /* silence puis rires */\n\nXorz: Ah oui vous voulez faire un parcours main gauche en fait !",
            ),
            array
            (
              'id' => "68",
            ...
            (
              ...
              'author' => "M. David Bouchet",
              'context' => "",
              'content' => "J'ai combien de bits ? 23\nEst-ce que c'est dur ? Non\nOn va en revoir tout le temps des comme ca !",
            ),
            array
            (
              'id' => "73",
            ...
            (
              ...
              'content' => "(En pointant la guêpe du doigt :) Bon la guêpe tu sors ! Tu perturbes le cours !\n\n\n[Après 2 min de blanc, Nicolet se retourne, la guêpe vient vers lui. Et du coup il rigole en la voyant voler...]",
            ),
            array
            (
              'id' => "75",
            ...
            (
              ...
              'content' => "Nathalie (en regardant sa montre) : Je parle trop !\n\nThibaud (en parlant à son voisin) : J'adore quand les femmes l'admettent.",
            ),
            array
            (
              'id' => "79",
            ...
            (
              ...
              'content' => "Tout d'abord, bon anniversaire !\n\nPour ta copine, c'est pas grave, comme tout bon geek, Mademoiselle Cinq Doigts prendra le relai pour te remonter le moral.\n\nProfites-en ce WE et reviens en forme lundi...",
            ),
            array
            (
              'id' => "81",
              ...
              'content' => "Elève (justificatif):\n\n => Il y avait un mouton devant ma porte, je ne pouvais pas sortir...\n\n\nRéponse de Pedro:\n\n => Fallait faire un méchoui...",
            ),
            array
            (
              'id' => "82",
              ...
              'content' => "Et merde, je compile le bin à la racine...\net moi j'ai rendu et je suis baisé.",
            ),
            array
            (
              'id' => "83",
            ...
            (
              ...
              'content' => "Issa Ghanem: *question*\n\nPelican: Une grosse TECHA ?!\n\nIssa Ghanem: Oui tout à fait, ce n'est qu'une question de profondeur !",
            ),
            array
            (
              'id' => "87",
            ...
            (
              ...
              'content' => "Christel : Bon, allez, Matthieu, tu dégages.\n\nMatthieu : Mais c'est votre blague qui m'a fait rigoler !\n\nChristel : Quelle blague ?\n\nMatthieu : C'était pas une blague ?\n\nChristel : Non...\n\nMatthieu : Ha merde !\n\nChristel : Allez, dégage !\n",
            ),
            array
            (
              'id' => "90",
              ...
              'content' => "guilbe_p : Quoi craquer le pantalon ?\n\nvu_c : On disait que tu craquais ton pantalon à chaque fois que tu voyais Zellagui.\n\nguilbe_p : Mais oui carrément!",
            ),
            array
            (
              'id' => "91",
              ...
              'context' => "Définissant une structure C au tableau\n[note : Akim Demaille est fan de la couleur orange].",
              'content' => "Je crée ma structure my2. J'aurais pu l'appeler 2my, mais j'avais pas de craie orange.\n",
            ),
            array
            (
              'id' => "92",
              ...
              'author' => "Cédric R. - spycAm",
              'context' => "",
              'content' => "- Pour s'incrire à l'offre M$ pour acheter Office, il faut entrer l'adresse email de son école.\n\n- J'entre raud_c@epita.fr ça foire\n\n- raud.cedric@epita.fr ça foire\n\n- cedric.raud@epita.fr ça foire\n\n- raud_c@isbp.fr ça marche\n\n- On est pas blacklisté déjà...\n\n",
            ),
            array
            (
              'id' => "93",
            ...
            (
              ...
              'content' => "- Boullay: Mais vous avez installé Objective CAML ?\n\n- Elève: Non.\n\n- Boullay: Ah ! Il est mignon...\n",
            ),
            array
            (
              'id' => "95",
            ...
            (
              ...
              'author' => "ACD",
              'context' => "",
              'content' => "- Lliane : On est obligé de sortir pour la pause ?\n\n- ACD : Non, tu peux rester là faire du C, connard !",
            ),
            array
            (
              'id' => "99",
              ...
              'context' => "\n http://www.informacyde.com/weblog/images/people/Bill-gates-mugshot.jpg",
            ...
            (
              ...
              'content' => "Rodot : Ah ! Par contre celui-là je le connais, il y en a des centaines dans l'annuaire, c'est très facile : N'Guyen\n\nVincent Nguyen : Non monsieur, ça se prononce Nuyen !\n\nRodot (boulversé) : QUOI ? C'est pas vrai ? C'est pas possible ?",
            ),
            array
            (
              'id' => "103",
            ...
            (
              ...
              'author' => "Melle. Christel Trémoulet",
              'context' => "",
              'content' => "Christel: Le premier qui dit que ça converge parce que ça tend vers 0, je le... il a un gage. \n\nJ-M: Tout nu dans l'escalier...\n\nChristel: Ah oui, pas mal ça !",
            ),
            array
            (
              'id' => "105",
              ...
              'context' => "",
              'content' => "Jimmy:	Les épées sont faites en latex aussi.\n\nBatiste: Ah!",
            ),
            array
            (
              'id' => "106",
              ...
              'author' => "j00",
              'context' => "",
              'content' => "Sadomaso c'est aussi du Cosplay non ?\n",
            ),
            array
            (
              'id' => "107",
              ...
              'author' => "M. Patrick Peillon",
              'context' => "",
              'content' => "Dans les armes à destination que je préfère, il y a la baguette de pain bien cuite.\n\nOn peut facilement arracher une joue avec ça !",
            ),
            array
            (
              'id' => "108",
            ...
            (
              ...
              'content' => "Mais c'est TROP bien ! Faut que je le montre à l'autre d'à coté (Boullay)\n [...]\n Pff, il s'en fout...",
            ),
            array
            (
              'id' => "112",
            ...
            (
              ...
              'author' => "j00",
              'context' => "",
              'content' => "Anne Lacan:	Mais je regarde pas les pétasses qui se pavanent sur TF1.\n\nJ00:		Mais qu'est-ce que tu fous à cette table?",
            ),
            array
            (
              'id' => "114",
            ...
            (
              ...
              'content' => "Zellagui: Mr Haddioui, vous faites quoi ? Vous êtes en train de sortir du cours en douce ?\n\nYassin:	Heu\n(Il était accroupi derrière une table, à un mètre de la porte, son sac sur le dos) Euh... je cherche ma gomme...\n\nZellagui reprend le cours. Se retourne a nouveau. Reprend le cours. Se retourne... Yassin est parti.\n",
            ),
            array
            (
              'id' => "116",
            ...
            (
              ...
              'author' => "M. Patrick Peillon",
              'context' => "",
              'content' => "M. Peillon:	Il y a des grand maître de l'érotisme ici ?\n\nJ-M:		Oui! La pelle, la truelle, hein Batiste?\n\nM. Peillon:	Hmm, vous êtes le bienvenu.\n\nBatiste:		Non ça c'est Jean-Marc.\n\nM. Peillon:		Ah c'est un frustré ? C'est ce que j'aime à Epita, cette troisième mi-temps dans les vestiaires.\n",
            ),
            array
            (
              'id' => "119",
            ...
            (
              ...
              'content' => "Putain, il y a du sang qui coule de mes oreilles là.\n...\nJ'ai envie de me pendre sérieux.\n",
            ),
            array
            (
              'id' => "121",
              ...
              'author' => "Robin Nozay",
              'context' => "",
              'content' => "Mme Zellagui:	Bon Monsieur Durand, arrêtez de rire.\n\nRobin:		Vous sortez du rang!",
            ),
            array
            (
              'id' => "122",
              ...
              'author' => "M. Christophe Boullay",
              'context' => "",
              'content' => "Faut que j'arrive à dégazer. (Lapsus sur \"dégager\", cours sur les graphes...)",
            ),
            array
            (
              'id' => "123",
            ...
            (
              ...
              'content' => "JM: Oh le batard\n\n/* 5 minutes de reflexion */\n\nKrisboul: Je ne sais pas... si on peut le traiter de ça...",
            ),
            array
            (
              'id' => "125",
            ...
            (
              ...
              'author' => "Promethe",
              'context' => "",
              'content' => "M. Bouchet:	C'est le bus quoi ?\n\nProm: Le bus Magique !\n",
            ),
            array
            (
              'id' => "127",
            ...
            (
              ...
              'content' => "Oh! C'est un bel objet, waah !\n\nIl se colle et se frotte au tableau...",
            ),
            array
            (
              'id' => "134",
            ...
            (
              ...
              'author' => "M. Christophe Boullay",
              'context' => "",
              'content' => "Warren:	Euh, pourquoi G(graphe) c'est une variable ?\n\nKrisboul: Parce que t'es dans une procédure. [...] Putain c'est complètement con ce que je viens de dire.",
            ),
            array
            (
              'id' => "136",
            ...
            (
              ...
              'author' => "M. O.R",
              'context' => "",
              'content' => "Des fois je me dis... c'est moi qui doit être spécial...\n\n[...]\n\nJe vous donnerai des boules...",
            ),
            array
            (
              'id' => "143",
            ...
            (
              ...
              'author' => "M. Patrick Peillon",
              'context' => "",
              'content' => "M. Peillon: Je peux entrer ?\n\nBob: Euh, non on a pas fini.\n\nWarren: OMG, on vire le prof.",
            ),
            array
            (
              'id' => "147",
            ...
            (
              ...
              'content' => "La xénographie c'est quoi ?\n\nC'est le mode de reproduction des...\n\n\n\n... des documents.",
            ),
            array
            (
              'id' => "151",
            ...
            (
              ...
              'author' => "Jean-Marc Le Roux",
              'context' => "",
              'content' => "Jean-Marc : Avec ton pote qui fait que se gratter...\n\nJean-Marc : Mattou c'est Frot'man.\n\nDamien : C'est un gratteur, et alors ?\n\nDamien : C'est sympa pour les jeux à gratter.\n\nJean-Marc : Pfffffffffff...\n\nJean-Marc : Ouais, bin il est plus Solitaire que Millionnaire !",
            ),
            array
            (
              'id' => "154",
              ...
              'author' => "Mattou",
              'context' => "",
              'content' => "Warren: J'aimerais pas avoir le dos courbé plus tard. Ca me ferait mal au cul !\n\nMattou: Et tu le free quand ? Ya un leak là !\n\n/* Relire la phrase plusieurs fois à haute voix pour comprendre */",
            ),
            array
            (
              'id' => "155",
              ...
              'content' => "j00 - J'ai acheté 4 Go de RAM pour mon portable.\n\npheteon - Sale gamer !\n\nj00 - Même pas, c'est pour me forcer à installer Windows Server 64 bits :x",
            ),
            array
            (
              'id' => "156",
            ...
            (
              ...
              'rank' => "-11",
              'author' => "lalien (vu_c)",
              'context' => "Sur son Pseudo MSN : \"en revisions de partiels\".\n\n[Note de l'admin: ce mec s'est auto-quoté -_-']",
            ...
            (
              ...
              'author' => "bour_a",
              'context' => "Sur MSN.",
              'content' => "Parso: Gabriel ?\n\nParso: C'est le père de Madmass ?",
            ),
            array
            (
              'id' => "162",
            ...
            (
              ...
              'content' => "- Minimoi : Où est internet?\n\n- Claire : Je suis assise dessus !\n\n- Farden : WTF ?\n\n- Claire : Putain j'ai des grosses fesses...",
            ),
            array
            (
              'id' => "165",
            ...
            (
              ...
              'author' => "Fabien Choutal",
              'context' => "",
              'content' => "- Jérôme: T'as qu'à faire un rm étoile sauf le fichier.\n\n- Fabien: Tu connais la commande 'rmsauf' toi ?",
            ),
            array
            (
              'id' => "168",
              ...
              'content' => "Annonce :\n\n~ Bonjour,    Le rendu d'IBC++ aura lieu le Dimanche 23 Mars 2008 a 12h00 au lieu du mercredi 19 mars 2008.    Un deuxième rendu intermédiaire sera ouvert le mercredi 19 mars entre  12h45 et 13h30.    N'oubliez pas de bien équilibrer votre charge de travail entre IBC++ et TC4.    Cordialement,\n\n\n\nWarren: OMFG :D\n\nWarren: TROUVE UN PUTAIN DE MOYEN D'EMPÊCHER CÉDRIC DE LIRE CETTE NEWS !",
            ),
            array
            (
              'id' => "169",
              ...
              'author' => "Chery",
              'context' => "",
              'content' => "Chery : moi je suis 100% camerounaisse\n\nChery : camerounaise\n\nChery : mais je resemble à une chinoise.",
            ),
            array
            (
              'id' => "170",
              ...
              'content' => "- Prof: Est-ce que quelqu'un se rappelle d'un fabricant de minis ?\n\n- Manu: Aston Martin.",
            ),
            array
            (
              'id' => "171",
            ...
            (
              ...
              'author' => "M. Patrick Peillon",
              'context' => "",
              'content' => "- Patrick : J'ai passé les 60 ans...\n\n- Un éleve : Et c'est dur?\n\n- Patrick : Non, plus très dur, justement...",
            ),
            array
            (
              'id' => "174",
            ...
            (
              ...
              'context' => "Tiger, C++...",
              'content' => "- Johan Soula : Ah c'est ca, mutable c'est const qu'on peut modifier qu'une fois ?\n\n- Vincent Camus : Et deux fois c'est mutable mutable ?\n\n",
            ),
            array
            (
              'id' => "178",
            ...
            (
              ...
              'context' => "Mister Vincent n'a pas fait de courses depuis quelques mois (rush TC et larguage quand tu nous tiens !) et fait sa liste de courses pour ses parents a 1h30 du mat' samedi alors que ses parents arrivent sans doute l'aprem.\n\n\n\nPS : la liste ultime avec des fraises tagada, des kinders et la citation... puis des saucisses du Nord !",
              'content' => "Vincent Nguyen : \"Ah mince, il y avait un truc super important que je voulais demander à mes parents... mince c'est quoi ?\"\n\nAh oui ! Des yaourts.  \n\n(cherchant encore...)\n\nVincent : en plus j'y avais pensé hier soir... puis après c'était le matin.",
            ),
            array
            (
              'id' => "182",
            ...
            (
              ...
              'author' => "Mankalas",
              'context' => "",
              'content' => "- Michaël: \" Ecoute-moi bien mon petit José, tu baises les ménagères. Bien, tu dois avoir le cul qui brille.  Mais c'est pas ça qu'on appelle la classe. \"\n\n- Kypper: Eh chapeau. Elle n'est pas facile à placer, celle-là.\n\n- Mankalas: CTB",
            ),
            array
            (
              'id' => "190",
              ...
              'context' => "",
              'content' => "Un GISTR qui retape son année, on le met dans un microprocesseur...\n\n...\n\nCa devient un registre !",
            ),
            array
            (
              'id' => "191",
            ...
            (
              ...
              'context' => "",
              'content' => "- tsuna: me.shower() && me.goto(World.France.Paris.EPITA.LRDE.L1);\n\n- mefyl: cat me | shower | dress\n\n            mv me /world/europe/france/paris/epita/lrde/l1\n\n- mefyl: echo \"Hé galère\" >> /dev/speak\n\n- tsuna: gmv: cannot move `me' to\n`/world/europe/france/paris/epita/lrde/l1': No such file or directory\n\n- tsuna: tu voulais dire /dev/world/... ?\n\n- tsuna: sed 's/hair/[some hairstyle here]/' -i me \n\n           && chroot /dev/world/europe/france/paris/epita/lrde/l1\n\n\n\nJe préfère quand même l'API C++.",
            ),
            array
            (
              'id' => "193",
              ...
              'author' => "M. Akim Demaille",
              'context' => "",
              'content' => "- Administration: À l'avenir, tout élève resté dans les locaux pendant une alarme est susceptible de se faire sanctionner avec sévérité.\n\n- Akim: Immolation par le feu ! ",
            ),
            array
            (
              'id' => "194",
            ...
            (
              ...
              'author' => "pidanc_j",
              'context' => "",
              'content' => "Diam's elle est trop bonne.\n\nElle a le coeur solide comme le diamant, parce que le diamant ca se raye pas t'as vu.\n\n",
            ),
            array
            (
              'id' => "196",
            ...
            (
              ...
              'author' => "LLB",
              'context' => "",
              'content' => "- yabo : [13:06:08] le-bru_l : J'ai contribué au bien de l'informatique.\n\nBon allez, le contexte : Il vient d'envoyer un patch à Microsoft pour un outil .Net\n\n- LLB: Rectification : j'ai fait une contribution à un outil gratuit, open-source et portable, qui représente clairement le futur de l'informatique. J'ai ajouté une fonctionnalité dans un compilateur, et je me remercierai pendant des années si elle est acceptée.  :) \n\nAprès, je suis prêt à en débattre avec n'importe qui.",
            ),
            array
            (
              'id' => "199",
              ...
              'author' => "lorin_d",
              'context' => "",
              'content' => "8-----lol\n\n8--lol\n\n8----lol\n\nBon c'est pas évident de faire du pr0n en ascii.",
            ),
            array
            (
              'id' => "200",
              'rank' => "0",
              'author' => "yabo",
              'context' => "yabo, Galeyte et Matthieu Bucchianeri rentrent pépère dans le métro. Une bande de mecs allumés entrent et commencent a débiter des conneries.\n\n\n\nSoudain, leur leader se tourne vers yabo et lui branle un charabia parlant de chataignes.",
            ...
            (
              ...
              'content' => "(23:43:09) bucchi_m: et l'eradication de l'espece humaine par la sodomie\n\n(23:43:09) yabo: l'éradication de l'espèce humaine par la sodomie ",
            ),
            array
            (
              'id' => "202",
              ...
              'context' => "",
              'content' => "- bucchi_m: C'est le temps de l'échange de bites entre nous deux.\n\n- yabo: Je te propose un duel pénien pour nous départager. Rejoins moi à 3h sous le pont de Tolbiac, amène tes témoins.",
            ),
            array
            (
              'id' => "203",
              ...
              'author' => "van-no_m",
              'context' => "",
              'content' => "J'arrive pas à passer l'anti-bot pour m'inscrire sur un forum :\n\n\"6 + 2 ? the answer must be in english (ex: six, two)\"",
            ),
            array
            (
              'id' => "204",
            ...
            (
              ...
              'context' => "",
              'content' => "- pierro_i: Woohoo!  J'ai réussi à installer Java en userland !\n\n- levill_r: Ah bah tu pourras le mettre sur ton CV ! Y'en a bien qui mettent \"bonne maîtrise de winzip\".",
            ),
            array
            (
              'id' => "209",
              'rank' => "4",
              'author' => "Tsuna",
              'context' => "Réponse au post suivant:\n\nLe site ne répond toujours pas et il ne reste que 6 minutes avant le rendu.\n\nPourrait-on décaler le rendu le temps que le site soit operationnel ?\n\nMerci beaucoup.",
            ...
            (
              ...
              'author' => "Anne Onyme",
              'context' => "",
              'content' => "P: Que pensez-vous de Linux ?\n\nB: C'est pas un OS de pédé, des fois y'a pas d'icônes.",
            ),
            array
            (
              'id' => "212",
              ...
              'context' => "",
              'content' => "- Mankalas: Quand je suis bourré, je montre ma bite.\n\n- Damien: Et le pire, c'est que c'est vrai, quelque soit l'endroit d'ailleurs.\n\n- Mankalas: Quand on était tous les deux à l'appart\", j'avais même pas besoin d'alcool. Hein grand fou ?",
            ),
            array
            (
              'id' => "214",
            ...
            (
              ...
              'author' => "Jean",
              'context' => "",
              'content' => "H: Jean, il est à combien le dollar ?\n\nJ: man ascii\n\nH: ...",
            ),
            array
            (
              'id' => "216",
            ...
            (
              ...
              'author' => "Shomaa",
              'context' => "",
              'content' => "DarkSoul: c'est quoi ton IP?\n\nDarkSoul: on va régler ton forward de ports\n\nShomaa: 127.0.0.1\n\nDarkSoul: ...\n\nShomaa: Ben quoi, j'ai que ça.",
            ),
            array
            (
              'id' => "219",
              ...
              'author' => "Rubix",
              'context' => "",
              'content' => "- Benji: Au Japon, au lieu de parler des langues bizarres comme le japonais, ils devraient parler en Python, c'est plus concis.\n\n- Rubix: Ils sont pas assez égoïstes pour dire self aussi souvent.",
            ),
            array
            (
              'id' => "220",
            ...
            (
              ...
              'content' => "Prof: Chez Alice, ils sont pas bons.\n\nFabien: Elle est bonne quand même.",
            ),
            array
            (
              'id' => "226",
            ...
            (
              ...
              'author' => "Yaka",
              'context' => "",
              'content' => "Yaka: Xavier il est où le tampon?\n\nVincent: Euh la je veux rien dire mais un DTC serait parfait.",
            ),
            array
            (
              'id' => "229",
            ...
            (
              ...
              'content' => "Jonathan: Ouais mais je valorise l'école moi aussi.\n\nJohan: Euh...\n\nJonathan: Ta gueule.",
            ),
            array
            (
              'id' => "240",
            ...
            (
              ...
              'content' => "Mais Marc il est au ralentit pour tout dans sa vie, sauf manger.\nC'est un peu un JarJar Binks Egyptien.",
            ),
            array
            (
              'id' => "243",
              ...
              'author' => "Warren Seine",
              'context' => "",
              'content' => "Jean-Marc: Pourquoi mon siège il vibre ?\n\nWarren: C'est le gode que tu as oublié de retirer de ton cul.",
            ),
            array
            (
              'id' => "244",
              ...
              'author' => "Jean-Marc Le Roux",
              'context' => "",
              'content' => "- Jean-Marc: Je vais à Forest Hill moi.\n\n- Warren: Ouais et alors, pourquoi tu me regardes avec un regard de tueur ?\n\n- Jean-Marc: Parce que moi je deviens beau, toi tu fais pousser tes cheveux, moi je fais pousser mes muscles.",
            ),
            array
            (
              'id' => "245",
              ...
              'author' => "preche_n",
              'context' => "",
              'content' => "- Bob: Il paraît que les mecs qui aiment les anchois ils aiment la bite. Tu aimes bien les anchois toi Nico ?\n\n- preche_n: Non j'aime pas les anchois. Pourtant qu'est-ce que j'aime la bite !",
            ),
            array
            (
              'id' => "246",
            ...
            (
              ...
              'author' => "Warren Seine",
              'context' => "En cours d'Anglais.",
              'content' => "- Warren: Hamlet? Euh... it was a writer!\n\n- Prof: No no, Shakespeare was the writer.",
            ),
            array
            (
              'id' => "248",
            ...
            (
              ...
              'content' => "rhaa-la-la... je suis quasiment pas cité  :-(\n\nça sert à quoi que je dise des conneries en cours ? hein ?\n\n(non mais !) ",
            ),
            array
            (
              'id' => "250",
              ...
              'content' => "Bonjour,\n\nJ'étais en finale départementale en équipe avec pidanc_j, de courses de montgolfières catégorie vent nord-nord-est dans la Creuse.\n\nJe n'ai ainsi pas pu participer au cours.\n\n\nVeuillez m'en excuser.",
            ),
            array
            (
              'id' => "251",
              ...
              'content' => "- Verna: Alors vous imaginez une petite vieille dame avec son paquet de pâtes, et vous avec quatre caddies pleins, ben vous la laissez passer, c'est un processus léger. Mais si vous en avez 10000 petites vieilles qui attendent, on fait quoi ?\n\n- CeD : on les killall.",
            ),
            array
            (
              'id' => "252",
            ...
            (
              ...
              'content' => "- Bertrand: Oui tu l'as là, la Vincent Team.\n\n",
            ),
            array
            (
              'id' => "257",
            ...
            (
              ...
              'author' => "Fabien Choutal",
              'context' => "",
              'content' => "- Renaud: Tu mérites le fist par pendaison!\n\n- Fabien: Ca veut rien dire en plus!\n\n[... petit blanc de 5 secondes ...]\n\n- Fabien: Ca veut rien dire hein?\n\n",
            ),
            array
            (
              'id' => "269",
              ...
              'content' => "- Et donc ils ont trouvé la qualité dans un puit.\n\n- Tu te rends compte ? Dans un puit.\n\n- Et après ils ont trouvé une centrale thermonucléaire dans un abribus !",
            ),
            array
            (
              'id' => "270",
            ...
            (
              ...
              'content' => "Un élève : Cure demande pourquoi epiquote est down.\n\nVincent : ils acceptent pas ma carte bleue  -_-",
            ),
            array
            (
              'id' => "272",
            ...
            (
              ...
              'content' => "- Cédric: Faire des Design Patterns c'est facile, il suffit de prendre des crayons foncés.\n\n- Warren: En plus c'est faux: il faut des crayons clairs!",
            ),
            array
            (
              'id' => "274",
            ...
            (
              ...
              'content' => "...\n\nAprès, je vous parlerais de ma vie, mon oeuvre.",
            ),
            array
            (
              'id' => "277",
            ...
            (
              ...
              'content' => "Cédric : Mon ecran ne marche plus !\n\nJean-Marc : Han, genre il marche plus ?\n\nCédric : Nan c'est juste qu'il n'affiche plus rien...",
            ),
            array
            (
              'id' => "282",
            ...
            (
              ...
              'context' => "",
              'content' => "- Laurent: Hey Pauline, je t'aime\n\n- Pauline: Quoi? Qu'est-ce que j'ai fait encore?",
            ),
            array
            (
              'id' => "288",
            ...
            (
              ...
              'author' => "Jonathan P.",
              'context' => "",
              'content' => "J'aurais dû entrer dans la Mafia.\n\nJ'me serais fait du fric, des putes et d'la coke.\n\nAvec plein de serveurs Sun sous Gentoo dans ma cave.",
            ),
            array
            (
              'id' => "292",
            ...
            (
              ...
              'context' => "En piscine, avec un ton super blase par l'exo 08 du Jour02.\n\nApres avoir appris que le gsed ne passe pas a la moulinette ...",
            ...
            (
              ...
              'content' => "Elève : Monsieur ?\n\nD. Verna (écrit au tableau): Attends...\n\nElève 2 : Han il t'a lock !",
            ),
            array
            (
              'id' => "298",
            ...
            (
              ...
              'content' => "Tu as tellement bien assisté au cours de systèmes que tu as même  fait un QCM ? IL N’Y PAS EU DE QCM EN SYSTEMES ET MICROPROCESSEURS ... \n\n\n\nArrêtes le bedo J",
            ),
            array
            (
              'id' => "309",
            ...
            (
              ...
              'author' => "Jean-Marc Le Roux",
              'context' => "Code",
              'content' => "Quand t'as un truc qui marche pas.\n\nMais vraiment pas.\n\nEt tu sais pas pourquoi.\n\nMais vraiment PAS.\n\nLe mieux, c'est de le supprimer.\n\nHOP\n\nniquel",
            ),
            array
            (
              'id' => "316",
            ...
            (
              ...
              'content' => "Metalman : Ho ho... trop facile...\n\nNath : Ouais bah vas-y, tiens...\n\nMetalman : J'peux prendre mon cahier ? Promis ! Je n'ai pas copie depuis celui de l'an passé ! :)\n\nNath : Pour ce qu'il y avait dedans...",
            ),
            array
            (
              'id' => "320",
            ...
            (
              ...
              'content' => "Warren: Putain, Firefox crashe à chaque fois que je vais sur le MySpace du Social Club...\n\nBenjamin: Vas-y accompagné!\n\n",
            ),
            array
            (
              'id' => "324",
              ...
              'content' => "Nath : Bon, alors faut savoir que c'est moi qui ait redigé le contrôle 1... enfin tout sauf l'exo 2, celui la c'est Marwan qui l'a fait !\n\nMais vous savez, pour le contrôle 2... C'est moi qui vait TOUT rediger !\n\nMetalman : Euh madame... vous pourrez laisser Marwan faire tout le partiel ?",
            ),
            array
            (
              'id' => "325",
            ...
            (
              ...
              'content' => "Jean-Marc Le Roux: Internet, si y'a personne pour le consulter\n\nJean-Marc Le Roux: c'est rien\n\nJean-Marc Le Roux: c'est du vice\n\nJean-Marc Le Roux: vide*\n\n",
            ),
            array
            (
              'id' => "336",
              ...
              'context' => "",
              'content' => "Caméra Espion : J'ai passé l'entretien MTI\n\n\nVincent  : Alors ?\n\n\nCaméra Espion : J'avais rien préparé, je me suis retrouvé comme un gland quand j'ai du citer 3 défauts >_< Mais sinon c'était sympa ^^\n\nVincent : Un peu d'aide? \n\n Défaut 1: je suis un gland\n\n Défaut 2: je ne prépare *jamais* quoi que ce soit\n\n Défaut 3: J'ai un mac [...] et un iPhone\n\nCaméra Espion : Trop pas, c'est MTI d'avoir un mac",
            ),
            array
            (
              'id' => "337",
            ...
            (
              ...
              'rank' => "3",
              'author' => "Warren Seine",
              'context' => "A lier avec la citation #339",
              'content' => "La garantie est perimée d un mois\n\n...\n\nClassique\n\n",
            ),
            array
            (
              'id' => "341",
            ...
            (
              ...
              'content' => "Krisboul : S'il existe un chemin de x vers y...\n\n*Temps pour recopier*\n\nKrisboul : Que x est marque, mais pas y...\n\nMetalman : C'est qu'on n'est pas encore arrivé au bout ?",
            ),
            array
            (
              'id' => "343",
              ...
              'content' => "Nath : Vous avez vu l'image du jour sur mon site ?\n\n*Plusieurs élèves* : Nooooon.... ça s'affiche pas !\n\nMetalman : Aaaah... vous savez pas coder Mme ! :o\n\nNath : J'appelle pas vraiment ça du \"code\" le HTML...",
            ),
            array
            (
              'id' => "344",
            ...
            (
              ...
              'author' => "Jean-Marc Le Roux",
              'context' => "",
              'content' => "Jean-Marc Le Roux: En gros, ça veut dire que sur mes deux cores pourris, j'en utilise qu'un...\n\nJean-Marc Le Roux: han, c'est ambigü comme phrase :-O ça fait grave nécro...",
            ),
            array
            (
              'id' => "347",
              ...
              'content' => "GoLLum : Epita (l).... j'ai hate !\n\nCaro : Tu vas les voir en concert ?\n\nGoLLuM : ...",
            ),
            array
            (
              'id' => "349",
            ...
            (
              ...
              'content' => "L'élève : c'est un potentiomètre ?\n\nMonsieur Jacquet : un potentiomètre ? et TA SOEUR ???",
            ),
            array
            (
              'id' => "356",
              ...
              'content' => "Junior : Alors vous voyez, c'est très utile, genre dans les compilos pour les dépendances, toussa... enfin allez voir votre chargé de TD info... moi la prog, hein...\n\nElève : Oooooh... :o\n\nJunior : Ah ! Mais c'est aussi très utile en cuisine ! Par exemple la recette de la crêpe aux bananes flambées !\n\nElève : Ah, ça par contre ça vous passionne :D",
            ),
            array
            (
              'id' => "357",
            ...
            (
              ...
              'content' => "Mais non mais la règles s'applique que sur les denombrables !!!\n\n\n\n(petit blanc)\n\n\n\nOuais, bon, j'ai pas dit que je savais ce que c'etait un dénombrable ...",
            ),
            array
            (
              'id' => "363",
              ...
              'content' => "mortie_q : Mais pourquoi il compile pas la  Victor ?!\n\n\n\nlenoir_v : (parlant a un saucisson) Ne l'ecoute pas, toi et moi on est heureux Saucisson !",
            ),
            array
            (
              'id' => "364",
              ...
              'content' => "Krisboul : Alors ! C'est quoi ca ! Je vais pas répéter 5 fois la même def ! Dépêche toi un peu...\n\nMetalman : Ah, mais j'ai mal à la main...\n\nKrisboul : Je sais pas ce que tu fais avec ta main droite, et j'm'en fiche... mais dans tous les cas, t'es la pour recopier ma def plus vite que ca!",
            ),
            array
            (
              'id' => "367",
            ...
            (
              ...
              'author' => "M. Marwan Burelle",
              'context' => "",
              'content' => "Marwan : Alors, Boullay m'a sorti une bonne énigme... regardez !\n\n*il ecrit 27972 au tableau*\n\nMarwan : Alors ! C'est quoi ca ?\n\nEtudiant : Un palindrome !\n\nMarwan : Aussi, mais encore...\n\n*10 mins passent avec toutes les possibilites*\n\nMarwan ; Vous ne savez pas ?.... C'est 666 * 42 ! :D",
            ),
            array
            (
              'id' => "373",
            ...
            (
              ...
              'content' => "- Je pense que je vais aller au concert de Metallica... Mais 90 euros pour rien voir dans la fosse, bof.\n\n- 90 euros pour se battre avec des mecs qui puent, autant taper un clochard dans la rue, ça revient moins cher.",
            ),
            array
            (
              'id' => "376",
              ...
              'content' => "Alex: Faudrait qu'on ramène les plateaux chez Avner.\n\nJérôme: C'est où ?",
            ),
            array
            (
              'id' => "377",
            ...
            (
              ...
              'content' => "MOR : J'aime les terrains vagues !\n\n*apres plusieurs explications sur ses sentiments envers eux*\n\nMetalman : Vous ne voulez pas faire un expose a M. Peillon la dessus ?\n\nMOR : AH ! Parce que lui aussi aime les terrains vagues ? :D",
            ),
            array
            (
              'id' => "380",
              ...
              'content' => "gavory_f 16:18:38 : dis, on a bousillé le makefile\n\n\n\nyou 16:19:01 : qu'est ce que t'as foutu ?\n\n\n\ngavory_f 16:19:11 : le Makefile s'est transformé en binaire",
            ),
            array
            (
              'id' => "381",
            ...
            (
              ...
              'content' => "- Jean-Marc: ça doit être trop chiant de dormir à 10cm l'un de l'autre\n\n- Michel: ouais! quand l'un se branle l'autre le sent.... alors autant le faire en même temps!",
            ),
            array
            (
              'id' => "411",
            ...
            (
              ...
              'content' => "ben il est gravé mais il est en lecture seule\n\n\n\nc'est pour ça que ça marche pas ?",
            ),
            array
            (
              'id' => "425",
            ...
            (
              ...
              'content' => "Pluplume : Tu sais, c'est pas grave si t'as une petite bite et un gros cul...!\n\nHakril : Mais nan, j'ai pas un gros cul!",
            ),
            array
            (
              'id' => "431",
            ...
            (
              ...
              'content' => "ACU : Deja qu'on a du mal a gerer les erreurs sur 20 lignes...\n\nEleve : et nous a coder sur 25...",
            ),
            array
            (
              'id' => "442",
            ...
            (
              ...
              'content' => "Prof : enfin j'ai trouve ..\n\n(pendant un gros blanc)\n\neleve : Nan ca c'est faux mec (en parlant a un autre eleve sur un sujet a part)\n\nProf : pardon ?",
            ),
            array
            (
              'id' => "449",
              ...
              'content' => "Metalman : Houuuuuu ! Je suis un zombie... j'attend que l'on informe mon pere de ma mort !\n\nGaby : Il faudrait vraiment faire un waitpid sur Metalman la...",
            ),
            array
            (
              'id' => "451",
              ...
              'content' => "prof : Do you think Google could take the total control of internet ?\n\nverdea_b : Yes ICANN !",
            ),
            array
            (
              'id' => "453",
            ...
            (
              ...
              'content' => "Mr Verna : oooh c'est mignon, elles se font un calins!\n\nMr Verna essaye d'enchainer avec la suite de son cours. Puis :\n\nMr Verna : bon ca suffit maintenant,j'arrive pas a me concentrer.",
            ),
            array
            (
              'id' => "464",
            ...
            (
              ...
              'rank' => "0",
              'author' => "martig_a",
              'context' => "En cours d'anglais avec Gavin Brown.\n\nNous préciserons que Jennifer est asiatique.",
              'content' => "Gavin : Jennifer, Do a sentence with \"get back\".\n\nmartig_a : *regardant jennifer avec un air sournois* Get back to china !",
            ),
            array
            (
              'id' => "485",
            ...
            (
              ...
              'content' => "Ptain ça me gave EPITA, toujours rien acheté comme cadeaux..\n\nMême pour les achats de noël je respecte pas la deadline.",
            ),
            array
            (
              'id' => "491",
              ...
              'content' => "- Shoun : Si vous avez moins de 10 lignes de code... ca sert a rien de venir en soutenance !\n\n\n\nEtudiant : Et si on a 11 lignes de commentaires ? :D\n\n\n\n- Shoun : ...\n\n\n\nEtudiant : Roooh ! C'était de l'humour !\n\n\n\n- Mehdi : Moi ca m'a fait rire en tout cas :D",
            ),
            array
            (
              'id' => "492",
            ...
            (
              ...
              'content' => "*Air de victoire* \n\nAprès le parcours largueur et le parcours profondeur, j'ai inventé le parcours diagonal !",
            ),
            array
            (
              'id' => "499",
              ...
              'context' => "Cours de marketing industriel.\nAprès une bonne réponse partielle d'un élève :",
            ...
            (
              ...
              'rank' => "0",
              'author' => "M. Vinh Van Diep",
              'context' => "Cours de marketing industriel.\nAprès une bonne réponse d'un élève",
            ...
            (
              ...
              'content' => "Et là on rentre dans la triple boucle...\n\n... ça nous fait un point en commun avec le patinage artistique !",
            ),
            array
            (
              'id' => "503",
            ...
            (
              ...
              'content' => "- New Deal : le lapin peut venir vous apporter des crêpes ! il peut même venir à poil !Suffit de demander !\n\n- Theo : En même temps... le lapin il viendra toujours à poil !... z'en avez vu à plumes ?",
            ),
            array
            (
              'id' => "506",
            ...
            (
              ...
              'content' => "Eleves : Vous avez pas froid monsieur ?!\n\nMarwan : Bah non...\n\nMetalman *avec une gross voix* ; C'est la flaaaaamme qui brule en lui ! >-)\n\nMarwan : Hehe... mais non ! C'est le pouvoir du poil !",
            ),
            array
            (
              'id' => "512",
            ...
            (
              ...
              'rank' => "1",
              'author' => "Autre",
              'context' => "M. Abderraouf Benali\n\nEn cours avec les GISTR2011",
            ...
            (
              ...
              'content' => "ElFahme : \"S'pas parce que y'a pleins d'Epita que tu dois te croire a l'ecole !\"\n\nMetalman : \"Bah je garde les bonnes habitudes\"\n\n*ElFahme apercoit le joli O'Reilly 'Sed et Awk'*\n\nElFahme : \"SED ET AWK ! OK J'ME CASSE !\"",
            ),
            array
            (
              'id' => "518",
            ...
            (
              ...
              'content' => "C'est trop fort un polynôme.\n\nC'est superman un polynôme !",
            ),
            array
            (
              'id' => "520",
            ...
            (
              ...
              'content' => "- Alors comme ca c'est vous la classe des STI ?\n\n/* La classe, a peu près en coeur */\n\n- Non, les STI c'est les C1 !\n\n/* Horgix, au premier rang, subitement se réveille et murmure: */\n\n- Ici c'est les autistes...\n\n/* La prof, surprise */\n\n- Pardon ?\n\n- Non, rien rien...\n\n/* Elle change d'expression */\n\n- Je vais continuer le cours comme si j'avais rien entendu...",
            ),
            array
            (
              'id' => "526",
            ...
            (
              ...
              'content' => "Pedro: C'est marrant, les polos représentent bien les différences entre les écoles !\n\nLe polo Noir EPITA pour le grand chef, des polos IPSA pour les associés... et les polos bleus {Epitech} s'occupent que des frites !",
            ),
            array
            (
              'id' => "530",
            ...
            (
              ...
              'content' => "gaudet_g : Tu peux me redire la blague?\n\nzaag_a : laquelle?\n\ngaudet_g : celle qui est drôle...",
            ),
            array
            (
              'id' => "533",
            ...
            (
              ...
              'author' => "pichot_f",
              'context' => "",
              'content' => "Tu veux une méta-blague ?\n\nBen c'est l'histoire d'un type...",
            ),
            array
            (
              'id' => "535",
              ...
              'content' => "Nous à Epitech on utilise FreeBSD.\n\nFreeBSD, c'est une VM !",
            ),
            array
            (
              'id' => "536",
              ...
              'content' => "Mr X - Tu boot sur linux la ?\n\nOeuf - Non c'est Fedora !",
            ),
            array
            (
              'id' => "537",
              ...
              'content' => "Dans mon message initial,\npar \"on peut ajouter...\" il fallait bien sûr entendre: \"on ne peut ajouter...\"",
            ),
